    ...
    <section class="contact">
         <div class="container">
            <div class="about__breadcrumb">
                <ul class="about__breadcrumb-menu">
                    <li class="about__breadcrumb-list">
                        <Link to="/">Home</Link>
                    </li>
                    <li class="about__breadcrumb-menu">/</li>
                    <li class="about__breadcrumb-link">
        ...
        <div class="contact__main">
            <div class="contact__item">
                <div class="contact__top">
                    <div class="contact__call">
                        ...
                        <p class="call__text">Call To Us</p>                            
                    </div>
                    <p class="text-days">We are available 24/7, 7 days a week.</p>
                    <p class="contact__number">Phone: +8801611112222</p>
                </div>
                <div class="contact__bottom">
                    <div class="icons__write">
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect width="40" height="40" rx="20" fill="#DB4444"/>
                            <path d="M10 13L20 20L30 13M10 27H30V13H10V27Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        <p class="contact__write">Write To US</p>    
                    </div>
            ...
            <form class="contact-form">
                ...
                <textarea class="message-textarea" placeholder="Your Massage" rows="12"></textarea>
                <div class="button">
                    <button class="contact__btn">Send Massage</button>
                </div>
            </form>
           </div>
        </div>
